...
from app.modules.crud_quiz_generations import crud_quiz_generative_router
from app.modules.quiz_generations import quiz_gen_router
...
modules_router.include_router(crud_quiz_generative_router)
